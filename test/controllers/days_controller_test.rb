...
class DaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create day" do
    assert_difference('Day.count') do
      post days_url, params: { day: { foods_eaten: @day.foods_eaten, symptoms: @day.symptoms } }
    end
  ...
  test "should update day" do
    patch day_url(@day), params: { day: { foods_eaten: @day.foods_eaten, symptoms: @day.symptoms } }
